...
function CustomeInputFieldsDynamicReports({
  inputFieldData,
  onChangeHandler,
  onBlurHandler,
  onValuesChange,
...
export default CustomeInputFieldsDynamicReports;
export { CustomeInputFieldsDynamicReports };

CustomeInputFieldsDynamicReports.propTypes = {
...
function InputFieldRenderer(props) {
  ...
  useEffect(() => {
    ...
    if (inputElement?.addEventListener) {
      ...
      // //            inputElement.addEventListener("blur", console.log("Blured"))
      //         );
  ...
  async function fetchData(
    ...
    try {
      if (isNextPageNull && action !== "search") return false;
