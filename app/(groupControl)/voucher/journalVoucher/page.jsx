...
export default function StickyHeadTable() {
  ...
  const validateAdd = () => {
    router.push("/voucher/journalVoucher/search");
  };
    ...
    try {
      ...
      if (!dataFetched) {
        ...
        let requestData = {
          ...
          clientId: clientId,
          filterCondition:
            "voucherTypeId= (select id from tblVoucherType where name='JOURNAL VOUCHER')",
          pageNo: 1,
        ...
        if (apiResponse.success === true && apiResponse.data?.length > 0) {
          const getVoucherDataCount = {
            columns: "id",
            tableName: "tblVoucher",
            whereCondition: `clientId=${clientId} and companyId=${defaultCompanyId} and companyBranchId=${defaultBranchId} and financialYearId=${defaultFinYearId} and voucherTypeId= (select id from tblVoucherType where name='JOURNAL VOUCHER')`,
  ...
  return (
    <div className="relative">
      <CustomeBreadCrumb name="Journal Voucher" />
